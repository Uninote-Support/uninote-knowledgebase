...
2. Choose how to use the template.
   * Use the default template as is
   * Add custom blocks based on the default template
   * Construct using only custom blocks without a template<br />

       <figure><img src="/images/image (15).png" alt="" /><figcaption></figcaption></figure>
3. Select the type of block to add.
   * **Plain Text**
   * **Bullet Points**
   * **Numbered List**
   * **Table with Borders**
